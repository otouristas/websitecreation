...
export const elHome = {
  ...
  hero: {
    ...
    trust1: 'SEO-ready από την 1η μέρα',
    trust2: 'Πολύγλωσσες ιστοσελίδες',
    trust3: 'Agency + τεχνική υποστήριξη',
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { title: 'SEO · GEO · AEO', description: 'Τεχνικό audit, schema, content, local SEO και βελτιστοποίηση για AI αναζήτηση.' },
      { title: 'Launch & ανάπτυξη', description: 'Go-live, παρακολούθηση GSC και συνεχής βελτιστοποίηση.' },
    ],
  },
  ...
  agencyPricing: {
    ...
    sub: 'Διαφανείς τιμές για τουρισμό και φιλοξενία. SEO, GEO/AEO included.',
    tiers: [
      { name: 'Starter', price: 'από €899', blurb: 'Μικρές επιχειρήσεις & rent-a-car', bullets: ['Έως 5 σελίδες', 'Responsive design', 'Βασικό SEO'] },
      { name: 'Professional', price: 'από €1.799', blurb: 'Ξενοδοχεία & tour operators', bullets: ['Έως 10 σελίδες', 'Gallery & κρατήσεις', 'Πλήρες SEO'] },
      { name: 'Business', price: 'από €2.999', blurb: 'Multi-property & πολύγλωσσο', bullets: ['Έως 20 σελίδες', 'AI chatbot', 'GEO/AEO'] },
    ],
    cta: 'Ζητήστε προσφορά',
    linkPricing: 'Όλες οι τιμές agency',
  },

  servicesGrid: {
    heading: 'Τι περιλαμβάνουν τα έργα μας',
    subheading: 'Κάθε ιστοσελίδα τουρισμού παραδίδεται με SEO-ready αρχιτεκτονική.',
    items: [
      { title: 'Κατασκευή ιστοσελίδας', desc: 'Custom design για ξενοδοχεία, rent-a-car και εκδρομές.' },
      { title: 'SEO web design', desc: 'Ταχύτητα, schema, internal linking και mobile-first UX.' },
      { title: 'Local SEO', desc: 'Google Business Profile, citations και σελίδες πόλης/νησιού.' },
      { title: 'GEO & AEO', desc: 'Βελτιστοποίηση για AI απαντήσεις και LLM citations.' },
      { title: 'AI chatbots', desc: 'Πολύγλωσσοι βοηθοί για κρατήσεις και FAQ.' },
      { title: 'Content & blogs', desc: 'Οδηγοί προορισμών και content hubs που rankάρουν.' },
    ],
...
export const EL_HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      'Ελλάδα, UK, US, Canada και Ευρώπη. Υποστηρίζουμε πολύγλωσσες ιστοσελίδες (ελληνικά, αγγλικά και άλλες γλώσσες κατόπιν συνεννόησης).',
  },
  {
    question: 'Πόσο κοστίζει μια ιστοσελίδα ξενοδοχείου ή rent-a-car;',
    answer:
  ...
  },
  {
    ...
    answer:
      'Starter sites: 2–3 εβδομάδες. Professional/Business: 4–8 εβδομάδες ανάλογα με περιεχόμενο, γλώσσες και integrations.',
  },
  {
