...
const BUILDERS: Record<string, Builder> = {
  ...
  'ai-visibility': (c) => ({
    ...
    paragraphs: [
      `Όλο και περισσότερες αναζητήσεις απαντώνται μέσα στο αποτέλεσμα - σε AI Overviews, στο ChatGPT, στο Perplexity και στο Gemini - χωρίς κλικ σε ιστοσελίδα. Το ζητούμενο αλλάζει: δεν αρκεί να κατατάσσεστε, πρέπει το περιεχόμενό σας να είναι σε μορφή που μπορεί να χρησιμοποιηθεί.`,
      `Δουλεύουμε σε δύο επίπεδα. GEO για το πώς παρουσιάζεται η επιχείρηση ως οντότητα, με συνέπεια στοιχείων και schema. AEO για το να απαντούν οι σελίδες σας ευθέως στις ερωτήσεις που κάνουν οι χρήστες, σε μορφή που μια μηχανή μπορεί να παραθέσει.`,
      `Παρακολουθούμε αναφορές σε σταθερό σύνολο ερωτημάτων ώστε να φαίνεται η τάση, χωρίς υπόσχεση ότι κάποια μηχανή θα σας αναφέρει. Η εμπορική υλοποίηση περιγράφεται στην υπηρεσία ορατότητας σε AI.`,
    ],
    deliverables: [
      'GEO για σαφήνεια οντότητας',
      'AEO για AI Overviews και απαντήσεις chat',
      'Schema και καθαρισμός οντοτήτων',
      'Δειγματοληψία αναφορών σε σταθερά ερωτήματα',
    ],
  }),
