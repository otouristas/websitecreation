...
const el: AiVisibilityPillarCopy = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Για όσες οι αγοραστές ήδη ρωτούν AI πριν κλείσουν ή καλέσουν: ξενοδοχεία, rent-a-car, tours και τοπικές υπηρεσίες με εμπορικά ερωτήματα. Αν ο κλάδος σας δεν έχει αυτή τη ζήτηση, θα σας το πούμε στον πρώτο έλεγχο. Για κλασικό SEO χωρίς αυτό το στρώμα, δείτε τις υπηρεσίες SEO.',
    },
  ],
  cta: {
