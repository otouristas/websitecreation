    ...
    el: [
      {
        ...
        answer:
          'Η ρύθμιση e-commerce ξεκινά από €600 ως add-on πάνω σε πακέτο ιστοσελίδας, ή ως scoped Business project. Το τελικό κόστος εξαρτάται από κατάλογο, πληρωμές και αποστολές.',
      },
      {
