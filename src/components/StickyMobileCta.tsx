    ...
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-background/95 px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur-md lg:hidden">
      <div className="mx-auto flex max-w-lg gap-2">
        <a
          ...
          className="btn btn-outline inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-xl px-0"
        >
        ...
        <Link
          ...
          className="btn btn-gradient h-12 flex-1 justify-center rounded-xl text-sm font-bold"
        >
          {nav.getQuote}
        </Link>
      </div>
