...
export const ESTIMATE_COPY = {
  en: {
    ...
    oneOff: 'One-off',
    monthly: 'Per month',
    firstInvoice: 'Due at kick-off',
    commitment: (months: number) => `Total over ${months} months`,
    band: 'Scoping band',
    net: 'net',
    vat: 'incl. VAT 24%',
    ...
    disclaimer:
      'An estimate, not a quote. Published prices, your inputs, and a ±15% band for what scoping usually moves. The quote follows a call.',
  ...
  el: {
    ...
    oneOff: 'Εφάπαξ',
    monthly: 'Ανά μήνα',
    firstInvoice: 'Πληρωτέο στην έναρξη',
    commitment: (months: number) => `Σύνολο σε ${months} μήνες`,
    band: 'Εύρος scoping',
    net: 'καθαρά',
    vat: 'με ΦΠΑ 24%',
    ...
    disclaimer:
      'Εκτίμηση, όχι προσφορά. Δημοσιευμένες τιμές, τα δικά σας δεδομένα και εύρος ±15% για όσα συνήθως μετακινεί το scoping. Η προσφορά ακολουθεί μετά από κλήση.',
