...
const CITY_INTROS: Record<string, { intro: string; tourism: boolean }> = {
  'athens-gr': {
    tourism: false,
    intro:
      'Η Αθήνα είναι η πιο ανταγωνιστική ψηφιακή αγορά της Ελλάδας: δικηγορικά γραφεία, ιατρεία, e-shop, εστίαση και B2B εταιρείες διεκδικούν τις ίδιες πρώτες θέσεις. Για να ξεχωρίσετε δεν αρκεί μια όμορφη ιστοσελίδα - χρειάζεστε τεχνικό SEO, ταχύτητα και περιεχόμενο που απαντά στις αναζητήσεις των Αθηναίων πελατών σας. Τα πακέτα κατασκευής ξεκινούν από €899 και τα μηνιαία SEO από €299 — με διαφανείς τιμές και δωρεάν προσφορά. Δουλεύουμε με δεδομένα από το Google Search Console και χτίζουμε σελίδες που στοχεύουν συγκεκριμένες συνοικίες και προθέσεις αγοράς.',
  },
  'thessaloniki-gr': {
    tourism: false,
    intro:
      'Η Θεσσαλονίκη συνδυάζει ισχυρή τοπική αγορά με χαμηλότερο διαφημιστικό κόστος από την Αθήνα - ιδανική συνθήκη για οργανική ανάπτυξη. Καταστήματα, φροντιστήρια, ιατρεία, e-shop και εταιρείες υπηρεσιών στη Θεσσαλονίκη κερδίζουν σταθερά πελάτες από αναζητήσεις όπως «κατασκευή ιστοσελίδων Θεσσαλονίκη», «κατασκευή eshop Θεσσαλονίκη» και «SEO Θεσσαλονίκη». Σχεδιάζουμε ιστοσελίδες και στρατηγική τοπικού SEO που σας βάζουν μπροστά από τον ανταγωνισμό της πόλης — με ξεκάθαρα πακέτα τιμών και CTA για δωρεάν προσφορά.',
  },
  'patras-gr': {
    tourism: false,
    intro:
