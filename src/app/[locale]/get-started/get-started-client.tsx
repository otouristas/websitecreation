...
function OnboardingWizard({ locale }: { locale: SiteLocale }) {
    ...
    // Set package/project from URL params + capture UTM
    useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        if (result.ok) {
            ...
            setSubmitError(result.error ?? 'There was an error submitting your request. Please try again.');
        }
                            ...
                            <div className="card p-6 sm:p-8">
                                ...
                                <div className="flex items-center justify-between mt-8 pt-6 border-t border-border">
                                    {step > 1 ? (
                                        ...
                                        <Link href={lp("/pricing")} className="btn btn-outline">Cancel</Link>
                                    )}
