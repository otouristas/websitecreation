...
faq:
  - question: "How often should I check Search Console?"
    answer: "Weekly one-hour ops minimum; daily during launch weeks or algorithm turbulence."
  - question: "Why don't GSC clicks match Analytics?"
    answer: "Different attribution, sampling, and URL grouping. Directional alignment matters more than pixel match."
...
- [Get-started form](/en/get-started) submissions by source

For [hotels](/en/solutions/hotels), attribute direct booking engine conversions. For [rent-a-car](/en/solutions/rent-a-car), track reservation completions by location page.
...
- [ ] Filter Performance by primary country + mobile
- [ ] Tag top 50 queries into protect / near-miss / test / noise
- [ ] Ship ≤3 fixes with written hypotheses
- [ ] Check Index → Pages for new coverage errors after deploys
- [ ] Spot-check GBP Insights vs top landing pages
- [ ] Log click deltas on last week's three URLs

Teams that treat this checklist as non-negotiable outperform teams that "check GSC when something feels wrong." Pair it with the [weekly ops playbook](/en/blog/gsc-weekly-ops-playbook) for minute-by-minute structure.
...
Prefer verified domain property when possible; segment by subdirectory in reports. [Hreflang](/en/glossary?term=hreflang) sites need careful URL inspection.
